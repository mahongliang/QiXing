...
<table id="select" class="easyui-datagrid" fit="true"
	url="<%=request.getContextPath()%>/machine/select" pagination="true"
	fitColumns="true" singleSelect="true" rownumbers="true" striped="true"
	border="false" nowrap="false">
	<thead>
		<tr>
			<th field="machineId" width="100">机器号</th>
			<th field="employeeName" width="100">操作员工</th>
			<th field="firstGrade" width="100">一等品</th>
			<th field="secondGrade" width="100">二等品</th>
			<th field="thirdGrade" width="100">三等品</th>
